...
function translater() {
    ...
    switch (option) {
        case "english":
            ...
            objetcs[8].innerHTML = "If you want to contribute to the development of <strong>Daydreams</strong>, you can donate to us, or simply sign in at Change.org. Help us to carry this project forward! ❤"
        ...
        case "español":
            ...
            objetcs[8].innerHTML = "Si quieres contribuir en el desarrollo de <strong>Daydreams</strong>, puedes donarnos, o simplemente firmar en Change.org. ¡Ayúdanos a sacar adelante este proyecto! ❤"
        ...
        case "portugues":
            ...
            objetcs[8].innerHTML = "Se você deseja contribuir para o desenvolvimento do <strong>Daydreams</strong>, você pode fazer uma doação para nós ou simplesmente assinar no Change.org. Ajude-nos a levar este projeto adiante! ❤"
